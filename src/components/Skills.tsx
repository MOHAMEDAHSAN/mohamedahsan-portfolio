...
const technicalSkills = [
  ...
  { name: "React + Vite", icon: "https://www.vectorlogo.zone/logos/vitejs/vitejs-icon.svg" },
  ...
  { name: "Confluence", icon: "https://www.vectorlogo.zone/logos/atlassian/atlassian-icon.svg" },
