...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary to-secondary/50 p-6 md:p-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex gap-4 pt-6">
              {socialLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="group relative p-3 bg-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 animate-scale-up"
                  style={{
          ...
          <div className="order-1 md:order-2 animate-fade-in">
            <div
              className="aspect-square rounded-3xl overflow-hidden bg-white p-2"
              style={{
